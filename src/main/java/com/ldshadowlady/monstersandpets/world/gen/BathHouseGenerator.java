...
public final class BathHouseGenerator extends MapGenStructure {
	private static final String NAME = "BathHouse";

	private static final String COMPONENT_NAME = "BthHs";
	...
	public BathHouseGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(BathHouseGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(BathHouseTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new BathHouseTemplate(mgr, pos, rotation)));
		}
	}
}
...
public final class PizzeriaTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "pizzeria");
	...
	public PizzeriaTemplate() {}

	public PizzeriaTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);
			...
			case "chest": {
				...
				if (sbb.isVecInside(chestPos)) {
					...
					if (entity instanceof TileEntityChest) {
						((TileEntityChest) entity).setLootTable(MonstersAndPetsLootTableList.PIZZERIA_CHEST, rng.nextLong());
					}
				}
				break;
			}

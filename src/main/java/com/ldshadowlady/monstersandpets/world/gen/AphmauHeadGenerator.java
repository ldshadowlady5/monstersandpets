...
public final class AphmauHeadGenerator extends MapGenStructure {
	private static final String NAME = "AphmauHead";

	private static final String COMPONENT_NAME = "AphHd";

	private static final int SEED = 173995;
	...
	public AphmauHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(AphmauHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(AphmauHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new AphmauHeadTemplate(mgr, pos, rotation)));
		}
	}
}
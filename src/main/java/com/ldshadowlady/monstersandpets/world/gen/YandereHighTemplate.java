...
public final class YandereHighTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "yandere_high");
	...
	public YandereHighTemplate() {}

	public YandereHighTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);
			...
			case "chest": {
				...
				if (sbb.isVecInside(chestPos)) {
					...
					if (entity instanceof TileEntityChest) {
						((TileEntityChest) entity).setLootTable(MonstersAndPetsLootTableList.YANDERE_HIGH_CHEST, rng.nextLong());
					}
				}
				break;
			}

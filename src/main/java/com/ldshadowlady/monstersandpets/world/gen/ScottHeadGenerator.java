...
public final class ScottHeadGenerator extends MapGenStructure {
	private static final String NAME = "ScottHead";
	...
	public ScottHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(ScottHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(ScottHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new ScottHeadTemplate(mgr, pos, rotation)));
		}
	}
}
...
public final class YammyHeadGenerator extends MapGenStructure {
	private static final String NAME = "YammyHead";

	private static final String COMPONENT_NAME = "YmyHd";

	private static final int SEED = 178546739;
	...
	public YammyHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(YammyHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(YammyHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new YammyHeadTemplate(mgr, pos, rotation)));
		}
	}
}
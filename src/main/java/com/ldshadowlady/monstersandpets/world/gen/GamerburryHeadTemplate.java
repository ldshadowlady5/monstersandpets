...
public final class GamerburryHeadTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "gamerburry_head");
	...
	public GamerburryHeadTemplate() {}

	public GamerburryHeadTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);

...
public final class WitherTowerTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "wither_tower");
	...
	public WitherTowerTemplate() {}

	public WitherTowerTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);
			...
			case "chest": {
				...
				if (sbb.isVecInside(chestPos)) {
					...
					if (entity instanceof TileEntityChest) {
						((TileEntityChest) entity).setLootTable(MonstersAndPetsLootTableList.WITHER_TOWER_CHEST, rng.nextLong());
					}
				}
				break;
			}

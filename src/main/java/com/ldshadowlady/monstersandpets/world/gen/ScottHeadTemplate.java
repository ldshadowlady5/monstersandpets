...
public final class ScottHeadTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "scott_head");
	...
	public ScottHeadTemplate() {}

	public ScottHeadTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);
			...
			case "scott_chest": {
				...
				if (sbb.isVecInside(chestPos)) {
					...
					if (entity instanceof TileEntityChest) {
						((TileEntityChest) entity).setLootTable(MonstersAndPetsLootTableList.SCOTT_CHEST, rng.nextLong());
					}
				}
				break;
			}

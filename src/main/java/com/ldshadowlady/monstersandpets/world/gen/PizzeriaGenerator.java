...
public final class PizzeriaGenerator extends MapGenStructure {
	private static final String NAME = "Pizzeria";

	private static final String COMPONENT_NAME = "Pza";

	private static final int SEED = 555729411;
	...
	public PizzeriaGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(PizzeriaGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(PizzeriaTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			BlockPos pos = new ChunkPos(chunkX, chunkZ).getBlock(12, y-5, 12);
			MinecraftServer server = world.getMinecraftServer();
			TemplateManager mgr = world.getSaveHandler().getStructureTemplateManager();
			return new Start(chunkX, chunkZ, Collections.singletonList(new PizzeriaTemplate(mgr, pos, rotation)));
		}
	}
}
...
public final class YandereHighGenerator extends MapGenStructure {
	private static final String NAME = "YandereHigh";

	private static final String COMPONENT_NAME = "YndrHgh";

	private static final int SEED = 55849;
	...
	public YandereHighGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(YandereHighGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(YandereHighTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			BlockPos pos = new ChunkPos(chunkX, chunkZ).getBlock(12, y-3, 12);
			MinecraftServer server = world.getMinecraftServer();
			TemplateManager mgr = world.getSaveHandler().getStructureTemplateManager();
			return new Start(chunkX, chunkZ, Collections.singletonList(new YandereHighTemplate(mgr, pos, rotation)));
		}
	}
}
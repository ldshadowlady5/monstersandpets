...
public final class AphmauHeadTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "aphmau_head");
	...
	public AphmauHeadTemplate() {}

	public AphmauHeadTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);
			...
			case "aphmau_chest": {
				...
				if (sbb.isVecInside(chestPos)) {
					...
					if (entity instanceof TileEntityChest) {
						((TileEntityChest) entity).setLootTable(MonstersAndPetsLootTableList.APHMAU_CHEST, rng.nextLong());
					}
				}
				break;
			}

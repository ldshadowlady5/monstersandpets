...
public final class KoilHeadGenerator extends MapGenStructure {
	private static final String NAME = "KoilHead";

	private static final String COMPONENT_NAME = "KoilHd";

	private static final int SEED = 5429;
	...
	public KoilHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(KoilHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(KoilHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new KoilHeadTemplate(mgr, pos, rotation)));
		}
	}
}
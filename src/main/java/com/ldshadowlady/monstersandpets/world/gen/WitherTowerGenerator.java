...
public final class WitherTowerGenerator extends MapGenStructure {
	private static final String NAME = "WitherTower";

	private static final String COMPONENT_NAME = "WthrTwr";

	private static final int SEED = 74439754;
	...
	public WitherTowerGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(WitherTowerGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(WitherTowerTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new WitherTowerTemplate(mgr, pos, rotation)));
		}
	}
}
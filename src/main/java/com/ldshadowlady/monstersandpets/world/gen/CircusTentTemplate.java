...
public final class CircusTentTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "circus_tent");
	...
	public CircusTentTemplate() {}

	public CircusTentTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);
			...
			case "chest": {
				...
				if (sbb.isVecInside(chestPos)) {
					...
					if (entity instanceof TileEntityChest) {
						((TileEntityChest) entity).setLootTable(MonstersAndPetsLootTableList.CIRCUS_TENT_CHEST, rng.nextLong());
					}
				}
				break;
			}

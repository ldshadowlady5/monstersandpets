...
public final class JoeyHeadTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "joey_head");
	...
	public JoeyHeadTemplate() {}

	public JoeyHeadTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);
			...
			case "joey_chest": {
				...
				if (sbb.isVecInside(chestPos)) {
					...
					if (entity instanceof TileEntityChest) {
						((TileEntityChest) entity).setLootTable(MonstersAndPetsLootTableList.JOEY_CHEST, rng.nextLong());
					}
				}
				break;
			}

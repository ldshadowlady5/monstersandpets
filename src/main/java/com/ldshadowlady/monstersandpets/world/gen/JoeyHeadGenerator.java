...
public final class JoeyHeadGenerator extends MapGenStructure {
	private static final String NAME = "JoeyHead";

	private static final String COMPONENT_NAME = "JoeyHd";

	private static final int SEED = 973742991;
	...
	public JoeyHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(JoeyHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(JoeyHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new JoeyHeadTemplate(mgr, pos, rotation)));
		}
	}
}
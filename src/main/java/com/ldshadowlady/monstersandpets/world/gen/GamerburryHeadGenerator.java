...
public final class GamerburryHeadGenerator extends MapGenStructure {
	private static final String NAME = "GamerburryHead";

	private static final String COMPONENT_NAME = "GmrBryHd";

	private static final int SEED = 93745953;
	...
	public GamerburryHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(GamerburryHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(GamerburryHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new GamerburryHeadTemplate(mgr, pos, rotation)));
		}
	}
}
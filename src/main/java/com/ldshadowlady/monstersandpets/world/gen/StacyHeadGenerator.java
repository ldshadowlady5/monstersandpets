...
public final class StacyHeadGenerator extends MapGenStructure {
	private static final String NAME = "StacyHead";

	private static final String COMPONENT_NAME = "StcyHd";

	private static final int SEED = 1912638;
	...
	public StacyHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(StacyHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(StacyHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new StacyHeadTemplate(mgr, pos, rotation)));
		}
	}
}
...
public final class SeapeekayHeadTemplate extends StructureComponentTemplate {
	private static final ResourceLocation ID = new ResourceLocation(MonstersAndPets.MODID, "seapeekay_head");
	...
	public SeapeekayHeadTemplate() {}

	public SeapeekayHeadTemplate(TemplateManager mgr, BlockPos pos, Rotation rotation) {
		super(0);

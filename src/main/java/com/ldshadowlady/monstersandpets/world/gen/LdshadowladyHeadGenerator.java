...
public final class LdshadowladyHeadGenerator extends MapGenStructure {
	private static final String NAME = "LdshadowladyHead";

	private static final String COMPONENT_NAME = "LDHd";

	private static final int SEED = 184620;
	...
	public LdshadowladyHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(LdshadowladyHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(LdshadowladyHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new LdshadowladyHeadTemplate(mgr, pos, rotation)));
		}
	}
}
...
public final class LaurenHeadGenerator extends MapGenStructure {
	private static final String NAME = "LaurenHead";

	private static final String COMPONENT_NAME = "LrnHd";

	private static final int SEED = 1937365;
	...
	public LaurenHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(LaurenHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(LaurenHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new LaurenHeadTemplate(mgr, pos, rotation)));
		}
	}
}
...
public final class OliHeadGenerator extends MapGenStructure {
	private static final String NAME = "OliHead";

	private static final String COMPONENT_NAME = "OliHd";

	private static final int SEED = 86544;
	...
	public OliHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(OliHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(OliHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new OliHeadTemplate(mgr, pos, rotation)));
		}
	}
}
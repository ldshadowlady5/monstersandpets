...
public final class JoelHeadGenerator extends MapGenStructure {
	private static final String NAME = "JoelHead";

	private static final String COMPONENT_NAME = "JoelHd";

	private static final int SEED = 9174921;
	...
	public JoelHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(JoelHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(JoelHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new JoelHeadTemplate(mgr, pos, rotation)));
		}
	}
}
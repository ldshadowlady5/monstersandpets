...
public final class DantdmHeadGenerator extends MapGenStructure {
	private static final String NAME = "DantdmHead";

	private static final String COMPONENT_NAME = "DnHd";

	private static final int SEED = 1749305;
	...
	public DantdmHeadGenerator(ChunkGeneratorOverworld generator) {
	...
	public static void init() {
		MapGenStructureIO.registerStructure(DantdmHeadGenerator.Start.class, NAME);
		MapGenStructureIO.registerStructureComponent(DantdmHeadTemplate.class, COMPONENT_NAME);
	}
	...
	public static final class Start extends StructureStart {
		...
		public static Start create(World world, ChunkGeneratorOverworld generator, Random rng, int chunkX, int chunkZ) {
			...
			return new Start(chunkX, chunkZ, Collections.singletonList(new DantdmHeadTemplate(mgr, pos, rotation)));
		}
	}
}
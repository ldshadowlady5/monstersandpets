...
public class EntityYandereKatelyn extends EntityMonsterUnspawnable {

	public EntityYandereKatelyn(World world) {
		super(world, MonstersUnspawnableType.YANDERE_KATELYN);

...
public class EntityChica extends EntityMonsterUnspawnable {

	public EntityChica(World world) {
		super(world, MonstersUnspawnableType.CHICA);
		this.setSize(1.2F,2F);
	}

	@Nullable
	protected ResourceLocation getLootTable() {return MonstersAndPetsLootTableList.CHICA;}

	@Override
	protected boolean isValidLightLevel(){ return true;}
	protected SoundEvent getAmbientSound()
	{
		return MonstersAndPetsSounds.CHICA;
	}
	@Override

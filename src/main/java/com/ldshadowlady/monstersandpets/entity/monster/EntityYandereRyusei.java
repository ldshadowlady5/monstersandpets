...
public class EntityYandereRyusei extends EntityMonsterUnspawnable {

	public EntityYandereRyusei(World world) {
		super(world, MonstersUnspawnableType.YANDERE_RYUSEI);

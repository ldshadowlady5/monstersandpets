...
public class EntityClown extends EntityMonsterUnspawnable {

	public EntityClown(World world) {
		super(world, MonstersUnspawnableType.CLOWN);
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		...
		setItemStackToSlot(EntityEquipmentSlot.OFFHAND, new ItemStack(MonstersAndPetsItems.BALLOON));

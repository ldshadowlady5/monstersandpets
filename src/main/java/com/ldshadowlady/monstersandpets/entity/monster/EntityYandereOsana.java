...
public class EntityYandereOsana extends EntityMonsterUnspawnable {

	public EntityYandereOsana(World world) {
		super(world, MonstersUnspawnableType.YANDERE_OSANA);

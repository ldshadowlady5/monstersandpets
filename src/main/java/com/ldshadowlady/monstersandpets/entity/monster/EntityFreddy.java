...
public class EntityFreddy extends EntityMonsterUnspawnable {

	public EntityFreddy(World world) {
		super(world, MonstersUnspawnableType.FREDDY);
		this.setSize(1.2F,2F);
	}

	@Nullable
	protected ResourceLocation getLootTable() {return MonstersAndPetsLootTableList.FREDDY;}

	@Override
	protected boolean isValidLightLevel(){ return true;}
	protected SoundEvent getAmbientSound()
	{
		return MonstersAndPetsSounds.FREDDY;
	}
	@Override

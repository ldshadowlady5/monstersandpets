...
public class EntityFoxy extends EntityMonsterUnspawnable {

	public EntityFoxy(World world) {
		super(world, MonstersUnspawnableType.FOXY);
		this.setSize(1.2F,2F);
	}

	@Nullable
	protected ResourceLocation getLootTable() {return MonstersAndPetsLootTableList.FOXY;}

	@Override
	protected boolean isValidLightLevel(){ return true;}
	protected SoundEvent getAmbientSound()
	{
		return MonstersAndPetsSounds.FOXY;
	}
	@Override

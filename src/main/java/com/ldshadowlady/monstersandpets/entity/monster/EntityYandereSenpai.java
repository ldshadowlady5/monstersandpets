...
public class EntityYandereSenpai extends EntityMonsterUnspawnable {

	public EntityYandereSenpai(World world) {
		super(world, MonstersUnspawnableType.YANDERE_SENPAI);
